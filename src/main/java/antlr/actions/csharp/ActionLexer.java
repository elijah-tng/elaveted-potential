...
public class ActionLexer extends antlr.CharScanner implements ActionLexerTokenTypes, TokenStream {
    ...
    public void reportWarning(String s) {
        if (getFilename() == null) antlrTool.warning(s);
        else antlrTool.warning(s, getFilename(), getLine(), getColumn());
    }
    ...
    protected final void mAST_CONSTRUCTOR(boolean _createToken)
        ...
        if (y != null) args += "," + y.getText();
        if (z != null) args += "," + z.getText();
            ...
            switch (LA(1)) {
                ...
                default:
                    if ((LA(1) == '-') && (LA(2) == '>') && (_tokenSet_13.member(LA(3)))) {
                        ...
                        {
                            if (((_tokenSet_17.member(LA(1))) && (_tokenSet_16.member(LA(2))) && (true))
