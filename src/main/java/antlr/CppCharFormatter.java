 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.7/antlr/CppCharFormatter.java#2 $
 */
...
class CppCharFormatter implements CharFormatter {
    ...
    public String escapeString(String s) {
        ...
        for (int i = 0; i < s.length(); i++) retval += escapeChar(s.charAt(i), false);
    ...
    public String literalChar(int c) {
        ...
        if (c >= 0 && c <= 126) ret += " /* '" + escapeChar(c, true) + "' */ ";
        return ret;
    }
