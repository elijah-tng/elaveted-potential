...
public class ChooseHashDirectoryNameBehavior implements ChooseDirectoryNameBehavior {
	...
	@Contract(pure = true)
	public ChooseHashDirectoryNameBehavior(final EDL_ICompilation aC, final LocalDateTime aLocalDateTime) {
		c = aC;
	...
	private @NotNull File choose_dir_name() {
		...
		tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("mkdirs 71 " + fn0);
		fn0.mkdirs();
