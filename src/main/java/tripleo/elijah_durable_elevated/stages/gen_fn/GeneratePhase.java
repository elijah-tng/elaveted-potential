...
import tripleo.elijah_durable_elevated.stages.gen_fn_c.GenFnC;
...
public class GeneratePhase implements ReactiveDimension, ModuleListener {
	private @NotNull final EDL_PipelineLogic pipelineLogic;
	private @NotNull final IPipelineAccess   pa;

	@Getter
	private final @NotNull EDL_ElLog.Verbosity               verbosity;
	@Getter
	private final @NotNull WorkManager                       wm                = new EDP_WorkManager();
	...
	public GeneratePhase(Verbosity aVerbosity, final @NotNull IPipelineAccess aPa, EDL_PipelineLogic aPipelineLogic) {
