...
public class TypeTableEntry {
	private final IExpression     __debug_expression;
	@NotNull
	...
	final         int             index;
	@NotNull
	private       GenType         genType = new GenTypeImpl();
	private       BaseEvaFunction __gf;
    private DeduceTypes2 _dt2;
    private @Nullable OS_Type attached;
...
//			throw new NotImplementedException();
			tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_2("73 " + aAttached);
			break;
		}
	}
	...
	public IExpression get__debug_expression() {
		return __debug_expression;
	}
