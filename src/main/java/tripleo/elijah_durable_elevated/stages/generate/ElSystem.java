 ...
 *
 */
package tripleo.elijah_durable_elevated.stages.generate;

import org.jetbrains.annotations.Contract;
import org.jetbrains.annotations.NotNull;
import tripleo.elijah_elevated_durable.comp.EDL_ICompilation;
import tripleo.elijah_durable_elevated.stages.gen_fn.*;
import tripleo.elijah_durable_elevated.stages.gen_generic.GenerateResultItem;
import tripleo.elijah_durable_elevated.stages.gen_generic.Old_GenerateResult;
...
public class ElSystem {
	...
	public ElSystem(final boolean aB, final EDL_ICompilation aC, final Supplier<OutputStrategy> aCreateOutputStratgy) {
		verbose = aB;
	...
	private void logProgress(final int code, final @NotNull /* @NotNull */ EvaNode evaNode, final String s) {
		...
		// 55: EvaConstructor
		// 140: not above
		tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_2(MessageFormat.format("{0} {1} {2}", code, evaNode.toString(), s));
	}
}
