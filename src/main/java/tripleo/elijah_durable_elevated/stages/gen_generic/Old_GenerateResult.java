...
import tripleo.elijah_durable_elevated.stages.gen_c.OutputFileC;
...
public class Old_GenerateResult implements GenerateResult {
	...
	public Old_GenerateResult() {
		// tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("*** ctor Old_GenerateResult");
	}
	...
	public void add(@NotNull Buffer b, @NotNull EvaNode n, @NotNull TY ty, @Nullable LibraryStatementPart aLsp,
		...
		if (aLsp == null) {
			tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_3("*************************** buffer --> " + b.getText());
			return;
		}
