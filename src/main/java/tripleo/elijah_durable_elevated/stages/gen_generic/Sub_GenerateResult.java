...
public class Sub_GenerateResult implements GenerateResult {
	...
	public Sub_GenerateResult() {
		// tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("** ctor Sub_GenerateResult");
	}
	...
	public void add(@NotNull Buffer b, @NotNull EvaNode n, @NotNull TY ty, @Nullable LibraryStatementPart aLsp,
		...
		if (aLsp == null) {
			tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_2("*************************** buffer --> " + b.getText());
			return;
		}
