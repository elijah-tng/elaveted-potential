...
import static tripleo.elijah_durable_elevated.util.Helpers0.mapCollectionElementsToString;
...
public class FnCallArgs implements InstructionArgument {
	...
	public String toString() {
		...
		final Collection<String> collect2 = mapCollectionElementsToString(instructionArguments);
