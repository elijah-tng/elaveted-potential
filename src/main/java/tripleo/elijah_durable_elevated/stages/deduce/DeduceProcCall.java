		...
		public DeclTarget(final @NotNull OS_Element aBest, final @NotNull OS_Element aDeclAnchor,
			...
			case VAR -> {
				...
				if (v.declaredTypeIsEmpty()) {
					tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("8787 declaredTypeIsEmpty for " + ((VariableStatement) element).getName());
					throw new FCA_Stop();
				} else {
					...
					final Operation<ClassInvocation> oi = ClassInvocationMake
