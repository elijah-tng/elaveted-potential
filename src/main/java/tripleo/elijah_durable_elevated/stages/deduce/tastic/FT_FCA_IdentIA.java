...
//							throw new IllegalStateException("Unexpected value: " + attached.getType());
	...
	public class FakeDC4 {
		...
		public DeferredMemberFunction deferred_member_function(final OS_Element aParent,
															   final IInvocation aInvocation2,
															   final FunctionDef aResolvedElement,
...
//			LOG.info("770 "+tte);
			...
			IExpression e = tte.get__debug_expression();
			if (e == null)
				continue;
			...
			case SUBTRACTION:
				int y = 2;
				tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_2("2363");
				break;
			case GET_ITEM:
