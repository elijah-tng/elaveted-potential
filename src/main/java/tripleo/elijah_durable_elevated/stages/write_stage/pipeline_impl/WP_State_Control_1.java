...
public class WP_State_Control_1 implements WP_State_Control {
	...
	public void markSuccess(final SC_Suc aSuc) {
		...
		tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("[%s] markSuccess (%s) (%s)".formatted("Default", this.getClass().getName(), aSuc.asString()));
	...
	public void markFailure(final SC_Fai aFai) {
		...
		// FIXME 10/19 just mark for now
		tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("[%s] markSuccess (%s) (%s)".formatted("Default", this.getClass().getName(), aFai.sc_fai_asString()));
		//NotImplementedException.raise_stop();
	}
