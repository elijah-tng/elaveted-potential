package tripleo.elijah_durable_elevated.stages.gen_c.c_ast1;
...
public class C_HeaderString {
	public static @NotNull C_HeaderString forClass(final EvaClass aEvaClass,
		...
		@NotNull EDL_ICompilation c = (@NotNull EDL_ICompilation) aEvaClass.getElement().getContext().module().getCompilation();
		if (c.reports().outputOn(EDL_Finally.Outs.Out_999022)) {
