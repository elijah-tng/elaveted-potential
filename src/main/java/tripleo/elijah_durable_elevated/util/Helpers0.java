...
//		md.update(input.getBytes(StandardCharsets.UTF_8));
	...
	public static void printXML(final Object obj, @NotNull final TabbedOutputStream tos) {
		tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("** XStream support has been disabled");
		/*
...
//			r.setRight(dotExpression);
	...
	public static List<EG_Statement> __combine_list_elements(final EG_Statement aB, final List<EG_Statement> aList2, final EG_Statement aE) {
		List<EG_Statement> res = new ArrayList<>();
		res.add(aB);
		res.addAll(aList2);
		res.add(aE);
		return res;
