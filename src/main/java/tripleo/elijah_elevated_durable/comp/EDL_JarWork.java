...
import clojure.lang.*;
import tripleo.elijah_durable_elevated.comp.internal.JarWork;
import tripleo.elijah_durable_elevated.comp.internal.WorkException;

import java.io.File;
import java.io.IOException;
import java.net.*;

public class EDL_JarWork implements JarWork {
	...
	public EDL_JarWork() throws WorkException {
		try {
			url = uri.toURL();
