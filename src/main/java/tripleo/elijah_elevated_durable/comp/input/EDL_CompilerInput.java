package tripleo.elijah_elevated_durable.comp.input;
...
public class EDL_CompilerInput extends _ElTaggableMixin implements CompilerInput {
	private final @NotNull Optional<EDL_ICompilation> oc;

	public EDL_CompilerInput(final String aS,
							 @SuppressWarnings("OptionalUsedAsFieldOrParameterType")
						  	final @Nullable Optional<EDL_ICompilation> aCompilation) {
		inp = aS;
