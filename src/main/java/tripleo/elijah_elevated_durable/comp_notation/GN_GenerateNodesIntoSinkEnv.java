...
public final class GN_GenerateNodesIntoSinkEnv implements GN_Env {
	...
	private final EDL_ElLog.Verbosity verbosity;
	...
	public static String getLang(final @NotNull OS_Module mod) {
		...
		if (lsp == null) {
			tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_2("7777777777777777777 mod.getFilename " + mod.getFileName());
			return null;
		}
	...
	static GenerateFiles getGenerateFiles(final @NotNull OutputFileFactoryParams params, final @NotNull WorldModule wm,
		...
		if (lang == null) {
			// 09/26 tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_err_4("lang==null for " + mod.getFileName());
	...
	public EDL_ElLog.Verbosity verbosity() {
		return verbosity;
	}
