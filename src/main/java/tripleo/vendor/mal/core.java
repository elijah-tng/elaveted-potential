...
public class core {
	...
	static @NotNull MalFunction prn = new MalFunction() {
		public MalVal apply(final @NotNull MalList args) throws MalThrowable {
			tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4(printer._pr_str_args(args, " ", true));
			return Nil;
		}
	};
	...
	static @NotNull MalFunction println = new MalFunction() {
		public MalVal apply(final @NotNull MalList args) throws MalThrowable {
			tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4(printer._pr_str_args(args, " ", false));
			return Nil;
		}
	};
