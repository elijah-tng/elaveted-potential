...
public class stepA_mal {
	...
	public static @Nullable MalVal EVAL(@NotNull MalVal orig_ast, @NotNull Env env) throws MalThrowable {
		...
		while (true) {
			...
			// tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4("EVAL: " + printer._pr_str(orig_ast, true));
			if (!orig_ast.list_Q()) {
...
//				tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4("IOException: " + e.getMessage());
//				break;
//			}
//			try {
//				tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4(PRINT(RE(repl_env, line)));
//			} catch (final MalContinue e) {
//				continue;
//			} catch (final MalException e) {
//				tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4("Error: " + printer._pr_str(e.getValue(), false));
//				continue;
//			} catch (final MalThrowable t) {
//				tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4("Error: " + t.getMessage());
//				continue;
//			} catch (final Throwable t) {
//				tripleo.elijah_fluffy.util.SimplePrintLoggerToRemoveSoon.println_out_4("Uncaught " + t + ": " + t.getMessage());
//				continue;
//			}
//		}
//	}
